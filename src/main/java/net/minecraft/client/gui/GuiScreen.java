...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void handleComponentHover(IChatComponent component, int x, int y)
    {
        ...
        {
            HoverEvent var4 = component.getChatStyle().getChatHoverEvent();
            ...
            else
            {
                    ...
                    if (this.mc.gameSettings.advancedItemTooltips)
                    {
                        try
                        {
                            ...
                            if (var12 instanceof NBTTagCompound)
                            {
                                ...
                                this.drawHoveringText(var14, x, y);
                            }
                            else
                            {
                ...
                {
                    this.drawHoveringText(NEWLINE_SPLITTER.splitToList(var4.getValue().getFormattedText()), x, y);
                }
                else if (var4.getAction() == HoverEvent.Action.SHOW_ACHIEVEMENT)
                {
                    ...
                    if (var13 != null)
                    {
                        ...
                        this.drawHoveringText(var9, x, y);
                    }
                    else
                    {
    ...
    protected boolean handleComponentClick(IChatComponent component)
    {
        ...
        {
            ClickEvent var2 = component.getChatStyle().getChatClickEvent();
